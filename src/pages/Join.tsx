...
export default function Join() {
      ...
      <div className="min-h-screen bg-nia-ivory flex items-center justify-center px-6">
        ...
        >
          ...
          <p className="text-sm font-light text-nia-muted">
            Call 9703356332 / 9885050850 and speak to Sandeep / Vinod before you leave.
          </p>
  ...
  return (
    <div className="min-h-screen bg-nia-ivory">
      <section className="min-h-[45vh] flex flex-col justify-end px-6 lg:px-12 pb-20 pt-32">
        <div className="max-w-[1280px] mx-auto w-full">
          <AnimatedSection>
            ...
            <p className="text-base font-light text-nia-gray max-w-xl leading-relaxed-custom">
      ...
      <section className="py-20 px-6 lg:px-12 border-t border-nia-border">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-16">
            <div className="lg:col-span-2 space-y-10">
              <AnimatedSection>
                <div className="space-y-8">
                  {[
                    ...
                    { num: '02', title: 'Qualify', desc: 'Personal call to understand fit and intent.' },
                    { num: '03', title: 'Grow', desc: 'Enter the room. Every meeting structured for your growth.' },
                  ].map((step) => (
                    <div key={step.num} className="flex gap-5">
                      <span className="text-2xl font-extrabold text-nia-border leading-none mt-1">
                        {step.num}
                      </span>
                      <div>
                        <h4 className="text-sm font-semibold text-nia-black mb-1 tracking-wide">
                          {step.title}
                        </h4>
              ...
              <AnimatedSection delay={0.2}>
                <div className="border-t border-nia-border pt-8">
                  <p className="text-xs tracking-ultra-wide uppercase text-nia-muted mb-4">
                    Membership Investment
                  </p>
                  <div className="space-y-2 text-sm font-light text-nia-gray">
                    <div className="flex justify-between">
                      <span>Membership Fee</span>
                      <span className="text-nia-black">₹60,000</span>
                    </div>
                    <div className="flex justify-between">
                      <span>Application Fee</span>
                      <span className="text-nia-black">₹8,500</span>
                    </div>
                    <div className="flex justify-between">
                  ...
                  <p className="text-xs font-light text-nia-muted mt-4 leading-relaxed-custom">
                    This is not a payment. The application is a first step. Investment details are discussed after qualification.
                  </p>
                </div>
              </AnimatedSection>
            </div>
            ...
            <div className="lg:col-span-3">
              <AnimatedSection delay={0.1}>
                {submitStatus === 'error' && (
                  <div className="border border-red-300 bg-red-50 p-4 mb-6 text-sm text-red-600 font-light">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    placeholder="Why do you want access to NIA Guntur? Be specific."
                    rows={4}
                    required
                  ...
                  <div className="pt-2">
                    <button
                      ...
                      className="w-full h-14 font-semibold text-sm tracking-[0.25em] uppercase bg-nia-orange text-nia-white border border-nia-orange hover:bg-nia-orange/90 hover:shadow-[0_0_32px_rgba(232,119,34,0.3)] transition-all duration-300 disabled:opacity-40 disabled:cursor-not-allowed"
                    >
                      {isSubmitting ? 'Submitting Application...' : 'Submit Application'}
                    </button>
                    <p className="text-xs text-center font-light text-nia-muted mt-4 leading-relaxed-custom">
