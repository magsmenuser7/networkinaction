...
import team from "../../public/ganeshcropped.jpg"
import building from "../../public/a56db7d4-1a61-4b46-9024-acd83239df9f.png"
...
export default function Contact() {
  ...
  const inputClass = 'w-full bg-nia-ivory border border-nia-border rounded-xl px-5 py-4 text-nia-black placeholder-nia-muted focus:border-[#f07723] focus:outline-none transition-all duration-200 text-sm font-light';
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-[#1e1e1e]">
            {[
              ...
              <AnimatedSection key={i} delay={i * 0.1} className="py-10 px-10 flex flex-col items-center text-center">
                <div className="w-10 h-10 bg-[#f07723]/10 border border-[#f07723]/20 flex items-center justify-center mb-5">
                  <Icon size={16} className="text-[#f07723]" />
                </div>
      ...
      <section className="py-32 px-6 lg:px-16">
        <div className="max-w-[1400px] mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-start">
            <AnimatedSection>
              <p className="text-xs font-light tracking-[0.4em] uppercase text-[#f07723] mb-6">Our Location</p>
              ...
              <div className="space-y-8 mb-12">
                <div className="flex items-start gap-5">
                  <div className="w-10 h-10 bg-[#f07723]/10 border border-[#f07723]/20 flex items-center justify-center shrink-0 mt-1">
                    <MapPin size={16} className="text-[#f07723]" />
                  </div>
                  <div>
                ...
                <div className="flex items-start gap-5">
                  <div className="w-10 h-10 bg-[#f07723]/10 border border-[#f07723]/20 flex items-center justify-center shrink-0">
                    <Phone size={16} className="text-[#f07723]" />
                  </div>
                  <div>
                    ...
                    <div className="space-y-1.5">
                      {[
                        ...
                        <div key={label} className="flex items-center gap-3">
                          ...
                          <a href={href} className="text-sm font-light text-nia-black hover:text-[#f07723] transition-colors">{num}</a>
                        </div>
                      ))}
                    </div>
                  </div>
                ...
                <div className="flex items-start gap-5">
                  <div className="w-10 h-10 bg-[#f07723]/10 border border-[#f07723]/20 flex items-center justify-center shrink-0">
                    <Mail size={16} className="text-[#f07723]" />
                  </div>
                  <div>
                    <p className="text-xs tracking-widest uppercase text-nia-muted mb-2">Email</p>
                    <a href="mailto:guntur@networkinaction.com" className="text-sm font-light text-nia-black hover:text-[#f07723] transition-colors">
              ...
              <div className="aspect-[4/3] relative overflow-hidden border border-nia-border rounded-xl">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6 pb-2">
                  <div className="bg-white/95 p-4 ">
                    <p className="text-xs tracking-widest uppercase text-[#f07723] mb-1">NIA Guntur</p>
            ...
            <AnimatedSection delay={0.15}>
              <p className="text-xs font-light tracking-[0.4em] uppercase text-[#f07723] mb-6">Send a Message</p>
              <h2 className="font-montserrat text-4xl md:text-5xl font-bold text-nia-black mb-10 leading-tight">
                We read every
                <br />message.
              </h2>
              ...
              {submitStatus === 'success' ? (
                <motion.div
                  ...
                  className="border border-[#f07723] p-8"
                >
                  <p className="text-xs tracking-widest uppercase text-[#f07723] mb-3">Message Received</p>
